...
class MessageConversationCubit extends Cubit<MessageConversationState> {
  ...
  MessageConversationCubit({required this.conversationId, required this.title})
      : super(MessageConversationState(conversationTitle: title));
  ...
  Future<void> fetchMessages() async {
    ...
    try {
      final messages =
          await UseCases.messageRepository.fetchMessages(conversationId);
  ...
  void _onEvent(PusherEvent event) {
    ...
    try {
      ...
      var newMsg = MessageItemModel.fromJson(msgJson);
  ...
  Future<void> sendMessage(String message,
    ...
    try {
      final sent = await UseCases.messageRepository
