...
class CustomDrawerConsultant extends StatelessWidget {
  const CustomDrawerConsultant({super.key});
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    DrawerMenuItem(
                      ...
                      title: loc.hb_lab,
                      onTap: () =>
                          Navigator.pushNamed(context, MyRoutes().hbLabView),
                    ),
                    DashedLine(),
                    DrawerMenuItem(
