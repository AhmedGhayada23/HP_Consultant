...
import 'package:hb/core/cubit/message_cubit/message_conversation_state.dart';
...
import 'package:hb/featuer/message/widgets/message_input_bar_widget.dart';
import 'package:hb/featuer/message/widgets/message_bubble.dart';
...
class _MessageChatViewState extends State<MessageChatView> {
  ...
  void _onSend(BuildContext context) {
    ...
    _controller.clear();
    context.read<MessageConversationCubit>().sendMessage(text);
  }
  ...
  void _showAttachmentPreview(BuildContext context, List<PlatformFile> files) {
    final cubit = context.read<MessageConversationCubit>();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: BlocBuilder<MessageConversationCubit, MessageConversationState>(
      ...
      body: BlocConsumer<MessageConversationCubit, MessageConversationState>(
