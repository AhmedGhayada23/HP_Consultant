...
class SubmitANewIdeaAccountingView extends StatefulWidget {
  const SubmitANewIdeaAccountingView({super.key});

  @override
  State<SubmitANewIdeaAccountingView> createState() =>
      _SubmitANewIdeaAccountingViewState();
}

class _SubmitANewIdeaAccountingViewState
    extends State<SubmitANewIdeaAccountingView> {
