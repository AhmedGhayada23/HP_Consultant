...
/// فقاعة رسالة بنمط الدعم: اسم المُرسِل بالأعلى + النص + المرفقات + الوقت بالأسفل
class ChatMessageBubble extends StatelessWidget {
  ...
  Widget _attachmentCard(
      BuildContext context, ChatAttachmentModel att, bool isMine) {
  ...
  Widget _fileCard(BuildContext context, ChatAttachmentModel att, bool isMine) {
