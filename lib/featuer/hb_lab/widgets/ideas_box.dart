...
import 'package:hb/featuer/hb_lab/presentation/details_ideas_box_view.dart';
import 'package:hb/l10n/app_localizations.dart';
import 'package:skeletonizer/skeletonizer.dart';

class IdeasBox extends StatelessWidget {
  const IdeasBox({super.key});

  @override
  Widget build(BuildContext context) {
    final loc = AppLocalizations.of(context)!;
    return BlocBuilder<HbLabIdeasBoxCubit, HbLabIdeasBoxState>(
