...
import 'package:hb/featuer/hb_lab/presentation/details_hb_lab_project.dart';
import 'package:hb/featuer/hb_lab/presentation/reevaluate_project_view.dart';
import 'package:hb/l10n/app_localizations.dart';
import 'package:skeletonizer/skeletonizer.dart';

class HbLabProject extends StatelessWidget {
  const HbLabProject({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocBuilder<HbLabProjectCubit, HbLabProjectState>(
                              ...
                              Expanded(
                                child: CustomButton(
                                  onTap: () => Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                        builder: (_) => ReevaluateProjectView()),
                                  ),
                            ...
                            Expanded(
                              child: CustomButtonBorder(
                                onTap: () => Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                    builder: (_) =>
                                        DetailsHbLabProject(hbLabProjectModel: item),
                                  ),
                                ),
