...
class FiltterHbLabWidget extends StatefulWidget {
  final int indexValue;
  final void Function(Map<String, dynamic> filters) onChanged;

  const FiltterHbLabWidget({
    super.key,
  ...
  @override
  State<FiltterHbLabWidget> createState() => _FiltterHbLabWidgetState();
}

class _FiltterHbLabWidgetState extends State<FiltterHbLabWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    // العرض مترجم، والقيمة المُرسَلة للخادم بالعربية
    final statuses = <String, String?>{
      loc.all: null, // الكل → بدون فلتر
      loc.under_review: 'قيد المراجعة',
      loc.rejected: 'مرفوض',
    };
    final categories = <String, String>{
      loc.category_ai_nlp: 'ذكاء اصطناعي / معالجة اللغات',
      loc.category_data_science: 'علم البيانات',
      loc.category_rpa_it: 'أتمتة / تقنية معلومات',
    };
